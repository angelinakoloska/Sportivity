...
<html lang="no">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="includes/clothing-pages/css/gallery.css">
    </head>
    <body>
        <header>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline mr-auto">
      ...
      <li class="nav-item">
        ...
        <div class="content">
            <div class="gallery">
                <a href="includes/clothing-pages/orderPage.php">
                  <img src="includes/clothing-pages/images/tshirt1.jpg">
                </a>
                <div class="title">Clique
                  <p>Blå sports t-skjorte</p>
                  <p>200 kr</p>
                </div>
            </div>
            <div class="gallery">
                <a href="#">
                  <img src="includes/clothing-pages/images/tshirt2.jpg"s>
                </a>
                <div class="title">Clique
                  <p>Blå sports t-skjorte</p>
                  <p>250 kr</p>
            ...
            <div class="gallery">
                <a href="#">
                  <img src="includes/clothing-pages/images/tshirt3.jpg">
                </a>
                <div class="title">Clique
                  <p>Blå sports t-skjorte</p>
                  <p>200 kr</p>
