  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="brukerlogin.php">Logg inn<span class="sr-only">(current)</span></a>
      </li>
      </ul>
  </div>
</nav>
    ...
    <form method="POST">
        Telefonnummer:
        <input name="telefonnummer_login" placeholder="tlf.nr." type="tel">
        Passord:
        <input name="passord_login" placeholder="passord" type="password">
        <button type="submit" formmethod="POST" name="login"> <a href="after_action/in_session.php">Logg inn</a>
        </button>
    </form>
