...
<html lang="no">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="brukerinnlogging.php">Lag en bruker<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="clothing-pages/tshirts.php">T-skjorter</a>
